        ...
        {events
          ...
          .map(event => (
            <div
              key={event.id}
              className={cn(
                "absolute left-2 right-2 rounded-md p-2 text-sm cursor-pointer",
            ...
            <React.Fragment key={time}>
              ...
              {days.map(day => (
                ...
                >
                  ...
                  {events
                    .filter(event => isSameDay(event.date, day) && event.startTime === time)
                    .map(event => (
                      <div
                        key={event.id}
                        className={cn(
            ...
            <div className="grid gap-4 py-4">
                ...
                <Popover>
                  ...
                  <PopoverContent className="w-auto p-0">
                    <CalendarComponent
                      ...
                      onSelect={date => setEditingEvent(prev => ({ ...prev, date: date || new Date() }))}
                    />
                  </PopoverContent>
                </Popover>
              </div>
              ...
              <div className="grid gap-2">
                ...
                <Select
                  ...
                  onValueChange={value => setEditingEvent(prev => ({ ...prev, color: value }))}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Select color" />
                  </SelectTrigger>
